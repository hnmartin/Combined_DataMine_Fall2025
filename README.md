...
2. Access JupyterHub:
    ...
    - Log in using your BoilerKey username and password. In the password field, enter your BoilerKey password and confirm the login with Duo Mobile.
    - Find Jupyterhub under "Interactive Apps"
    - Launch a new session with the default settings.
...
We have already created Conda Environment for your use, all it remains is to link this environment with your notebook: 
...
``` 
Load a common kernel from the common area, for example, this kernel: 
```
...
```
git clone https://github.com/hnmartin/Combined_DataMine_Fall2025.git
